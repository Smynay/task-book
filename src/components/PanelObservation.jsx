    ...
    <div className="observation-panel panel">
      ...
      <div className="observation">
        <div className="observation__items">
          {/* TODO: поправить ошибочки */}
          <div className="observation__item">
            Больше всего задача вы создаёте в <span>Понедельник</span>
          </div>
          <div className="observation__item">
            Больше всего задача вы завершаете в <span>Вторник</span>
          </div>
        </div>
      </div>
    </div>
